...
public class Ejercicio03 {
     ...
     *
     * 1. Ingresar la nota de un alumno y le devuelva el mensaje “Usted obtuvo
     * la mención de #mencion#”, 2. Reemplazando la expresión #mencion# por el
     * valor correspondiente (String.replace), según el cuadro mostrado:
     *
     *              Nota                   Mención
     *
     *        > 18   y  <= 20             Excelente
    ...
    public static void main(String[] args) {
        ...
        String msj = switch (nota) {
            case Integer n when (n > 18 && n <= 20) ->
                "Excelente";
            case Integer n when (n > 15 && n <= 18) ->
                "Bueno";
            case Integer n when (n >= 13 && n <= 15) ->
                "Regular";
            case Integer n when (n >= 0 && n < 13) ->
                "Deficiente";
            default ->
                "";
        };
